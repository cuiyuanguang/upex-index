/* eslint-disable */
var THREE = THREE || {}; THREE.Color = function (a) { this.autoUpdate = true; this.setHex(a); }; THREE.Color.prototype = {
  setRGBA(f, e, c, d) { this.r = f; this.g = e; this.b = c; this.a = d; if (this.autoUpdate) { this.updateHex(); this.updateStyleString(); } }, setHex(a) { this.hex = a; if (this.autoUpdate) { this.updateRGBA(); this.updateStyleString(); } }, copyRGB(a) { this.r = a.r; this.g = a.g; this.b = a.b; }, copyRGBA(a) { this.r = a.r; this.g = a.g; this.b = a.b; this.a = a.a; }, multiplySelfRGB(a) { this.r *= a.r; this.g *= a.g; this.b *= a.b; }, updateHex() { this.hex = Math.floor(this.a * 255) << 24 | Math.floor(this.r * 255) << 16 | Math.floor(this.g * 255) << 8 | Math.floor(this.b * 255); }, updateRGBA() { this.a = (this.hex >> 24 & 255) / 255; this.r = (this.hex >> 16 & 255) / 255; this.g = (this.hex >> 8 & 255) / 255; this.b = (this.hex & 255) / 255; }, updateStyleString() { this.__styleString = `rgba(${Math.floor(this.r * 255)},${Math.floor(this.g * 255)},${Math.floor(this.b * 255)},${this.a})`; }, toString() { return `THREE.Color ( r: ${this.r}, g: ${this.g}, b: ${this.b}, a: ${this.a}, hex: ${this.hex} )`; },
}; THREE.Vector2 = function (a, b) { this.x = a || 0; this.y = b || 0; }; THREE.Vector2.prototype = {
  set(a, b) { this.x = a; this.y = b; return this; }, copy(a) { this.x = a.x; this.y = a.y; return this; }, addSelf(a) { this.x += a.x; this.y += a.y; return this; }, add(b, a) { this.x = b.x + a.x; this.y = b.y + a.y; return this; }, subSelf(a) { this.x -= a.x; this.y -= a.y; return this; }, sub(b, a) { this.x = b.x - a.x; this.y = b.y - a.y; return this; }, multiplyScalar(a) { this.x *= a; this.y *= a; return this; }, unit() { this.multiplyScalar(1 / this.length()); return this; }, length() { return Math.sqrt(this.x * this.x + this.y * this.y); }, lengthSq() { return this.x * this.x + this.y * this.y; }, negate() { this.x = -this.x; this.y = -this.y; return this; }, clone() { return new THREE.Vector2(this.x, this.y); }, toString() { return `THREE.Vector2 (${this.x}, ${this.y})`; },
}; THREE.Vector3 = function (a, c, b) { this.x = a || 0; this.y = c || 0; this.z = b || 0; }; THREE.Vector3.prototype = {
  set(a, c, b) { this.x = a; this.y = c; this.z = b; return this; },
  copy(a) { this.x = a.x; this.y = a.y; this.z = a.z; return this; },
  add(b, a) { this.x = b.x + a.x; this.y = b.y + a.y; this.z = b.z + a.z; return this; },
  addSelf(a) { this.x += a.x; this.y += a.y; this.z += a.z; return this; },
  addScalar(a) { this.x += a; this.y += a; this.z += a; return this; },
  sub(b, a) { this.x = b.x - a.x; this.y = b.y - a.y; this.z = b.z - a.z; return this; },
  subSelf(a) { this.x -= a.x; this.y -= a.y; this.z -= a.z; return this; },
  cross(b, a) { this.x = b.y * a.z - b.z * a.y; this.y = b.z * a.x - b.x * a.z; this.z = b.x * a.y - b.y * a.x; return this; },
  crossSelf(c) {
    let b = this.x,
      a = this.y,
      d = this.z; this.x = a * c.z - d * c.y; this.y = d * c.x - b * c.z; this.z = b * c.y - a * c.x; return this;
  },
  multiplySelf(a) { this.x *= a.x; this.y *= a.y; this.z *= a.z; return this; },
  multiplyScalar(a) { this.x *= a; this.y *= a; this.z *= a; return this; },
  divideScalar(a) { this.x /= a; this.y /= a; this.z /= a; return this; },
  ...
  normalize() { if (this.length() > 0) { this.multiplyScalar(1 / this.length()); } else { this.multiplyScalar(0); } return this; },
  setLength(a) { return this.normalize().multiplyScalar(a); },
  isZero() { const a = 0.0001; return (Math.abs(this.x) < a) && (Math.abs(this.y) < a) && (Math.abs(this.z) < a); },
  clone() { return new THREE.Vector3(this.x, this.y, this.z); },
  toString() { return `THREE.Vector3 ( ${this.x}, ${this.y}, ${this.z} )`; },
}; THREE.Vector4 = function (a, d, c, b) { this.x = a || 0; this.y = d || 0; this.z = c || 0; this.w = b || 1; }; THREE.Vector4.prototype = {
  set(a, d, c, b) { this.x = a; this.y = d; this.z = c; this.w = b; return this; }, copy(a) { this.x = a.x; this.y = a.y; this.z = a.z; this.w = a.w; return this; }, add(b, a) { this.x = b.x + a.x; this.y = b.y + a.y; this.z = b.z + a.z; this.w = b.w + a.w; return this; }, addSelf(a) { this.x += a.x; this.y += a.y; this.z += a.z; this.w += a.w; return this; }, sub(b, a) { this.x = b.x - a.x; this.y = b.y - a.y; this.z = b.z - a.z; this.w = b.w - a.w; return this; }, subSelf(a) { this.x -= a.x; this.y -= a.y; this.z -= a.z; this.w -= a.w; return this; }, clone() { return new THREE.Vector4(this.x, this.y, this.z, this.w); }, toString() { return `THREE.Vector4 (${this.x}, ${this.y}, ${this.z}, ${this.w})`; },
  ...
  n43: 0,
  n44: 1,
  identity() { this.n11 = 1; this.n12 = 0; this.n13 = 0; this.n14 = 0; this.n21 = 0; this.n22 = 1; this.n23 = 0; this.n24 = 0; this.n31 = 0; this.n32 = 0; this.n33 = 1; this.n34 = 0; this.n41 = 0; this.n42 = 0; this.n43 = 0; this.n44 = 1; },
  copy(a) { this.n11 = a.n11; this.n12 = a.n12; this.n13 = a.n13; this.n14 = a.n14; this.n21 = a.n21; this.n22 = a.n22; this.n23 = a.n23; this.n24 = a.n24; this.n31 = a.n31; this.n32 = a.n32; this.n33 = a.n33; this.n34 = a.n34; this.n41 = a.n41; this.n42 = a.n42; this.n43 = a.n43; this.n44 = a.n44; },
  lookAt(d, c, b) {
    let a = this._x,
      f = this._y,
  ...
  transform(a) {
    let d = a.x,
      c = a.y,
      b = a.z,
      e = a.w ? a.w : 1; a.x = this.n11 * d + this.n12 * c + this.n13 * b + this.n14 * e; a.y = this.n21 * d + this.n22 * c + this.n23 * b + this.n24 * e; a.z = this.n31 * d + this.n32 * c + this.n33 * b + this.n34 * e; e = this.n41 * d + this.n42 * c + this.n43 * b + this.n44 * e; if (a.w) { a.w = e; } else { a.x /= e; a.y /= e; a.z /= e; } return a;
  },
  crossVector(b) { const c = new THREE.Vector4(); c.x = this.n11 * b.x + this.n12 * b.y + this.n13 * b.z + this.n14 * b.w; c.y = this.n21 * b.x + this.n22 * b.y + this.n23 * b.z + this.n24 * b.w; c.z = this.n31 * b.x + this.n32 * b.y + this.n33 * b.z + this.n34 * b.w; c.w = (b.w) ? this.n41 * b.x + this.n42 * b.y + this.n43 * b.z + this.n44 * b.w : 1; return c; },
  ...
  multiplyScalar(a) { this.n11 *= a; this.n12 *= a; this.n13 *= a; this.n14 *= a; this.n21 *= a; this.n22 *= a; this.n23 *= a; this.n24 *= a; this.n31 *= a; this.n32 *= a; this.n33 *= a; this.n34 *= a; this.n41 *= a; this.n42 *= a; this.n43 *= a; this.n44 *= a; },
  determinant() { return (this.n14 * this.n23 * this.n32 * this.n41 - this.n13 * this.n24 * this.n32 * this.n41 - this.n14 * this.n22 * this.n33 * this.n41 + this.n12 * this.n24 * this.n33 * this.n41 + this.n13 * this.n22 * this.n34 * this.n41 - this.n12 * this.n23 * this.n34 * this.n41 - this.n14 * this.n23 * this.n31 * this.n42 + this.n13 * this.n24 * this.n31 * this.n42 + this.n14 * this.n21 * this.n33 * this.n42 - this.n11 * this.n24 * this.n33 * this.n42 - this.n13 * this.n21 * this.n34 * this.n42 + this.n11 * this.n23 * this.n34 * this.n42 + this.n14 * this.n22 * this.n31 * this.n43 - this.n12 * this.n24 * this.n31 * this.n43 - this.n14 * this.n21 * this.n32 * this.n43 + this.n11 * this.n24 * this.n32 * this.n43 + this.n12 * this.n21 * this.n34 * this.n43 - this.n11 * this.n22 * this.n34 * this.n43 - this.n13 * this.n22 * this.n31 * this.n44 + this.n12 * this.n23 * this.n31 * this.n44 + this.n13 * this.n21 * this.n32 * this.n44 - this.n11 * this.n23 * this.n32 * this.n44 - this.n12 * this.n21 * this.n33 * this.n44 + this.n11 * this.n22 * this.n33 * this.n44); },
  transpose() { function a(d, e, c) { const b = d[e]; d[e] = d[c]; d[c] = b; }a(this, 'n21', 'n12'); a(this, 'n31', 'n13'); a(this, 'n32', 'n23'); a(this, 'n41', 'n14'); a(this, 'n42', 'n24'); a(this, 'n43', 'n34'); return this; },
  clone() { const a = new THREE.Matrix4(); a.n11 = this.n11; a.n12 = this.n12; a.n13 = this.n13; a.n14 = this.n14; a.n21 = this.n21; a.n22 = this.n22; a.n23 = this.n23; a.n24 = this.n24; a.n31 = this.n31; a.n32 = this.n32; a.n33 = this.n33; a.n34 = this.n34; a.n41 = this.n41; a.n42 = this.n42; a.n43 = this.n43; a.n44 = this.n44; return a; },
  flatten() { return [this.n11, this.n21, this.n31, this.n41, this.n12, this.n22, this.n32, this.n42, this.n13, this.n23, this.n33, this.n43, this.n14, this.n24, this.n34, this.n44]; },
  toString() { return `| ${this.n11} ${this.n12} ${this.n13} ${this.n14} |\n| ${this.n21} ${this.n22} ${this.n23} ${this.n24} |\n| ${this.n31} ${this.n32} ${this.n33} ${this.n34} |\n| ${this.n41} ${this.n42} ${this.n43} ${this.n44} |`; },
}; THREE.Matrix4.translationMatrix = function (b, d, c) { const a = new THREE.Matrix4(); a.n14 = b; a.n24 = d; a.n34 = c; return a; }; THREE.Matrix4.scaleMatrix = function (b, d, c) { const a = new THREE.Matrix4(); a.n11 = b; a.n22 = d; a.n33 = c; return a; }; THREE.Matrix4.rotationXMatrix = function (b) { const a = new THREE.Matrix4(); a.n22 = a.n33 = Math.cos(b); a.n32 = Math.sin(b); a.n23 = -a.n32; return a; }; THREE.Matrix4.rotationYMatrix = function (b) { const a = new THREE.Matrix4(); a.n11 = a.n33 = Math.cos(b); a.n13 = Math.sin(b); a.n31 = -a.n13; return a; }; THREE.Matrix4.rotationZMatrix = function (b) { const a = new THREE.Matrix4(); a.n11 = a.n22 = Math.cos(b); a.n21 = Math.sin(b); a.n12 = -a.n21; return a; }; THREE.Matrix4.rotationAxisAngleMatrix = function (b, d) {
  ...
  let e = o.flatten(),
    ...
    a = e[5] * e[0] - e[1] * e[4],
    h = e[0] * (n) + e[1] * (k) + e[2] * (j),
    b; if (h == 0) { throw 'matrix not invertible'; }b = 1 / h; l.m[0] = b * n; l.m[1] = b * i; l.m[2] = b * d; l.m[3] = b * k; l.m[4] = b * g; l.m[5] = b * c; l.m[6] = b * j; l.m[7] = b * f; l.m[8] = b * a; return l;
  ...
  let g,
    ...
    l,
    k,
    j; g = new THREE.Matrix4(); q = 2 * i / (r - f); n = 2 * i / (o - e); p = (r + f) / (r - f); l = (o + e) / (o - e); k = -(h + i) / (h - i); j = -2 * h * i / (h - i); g.n11 = q; g.n12 = 0; g.n13 = p; g.n14 = 0; g.n21 = 0; g.n22 = n; g.n23 = l; g.n24 = 0; g.n31 = 0; g.n32 = 0; g.n33 = k; g.n34 = j; g.n41 = 0; g.n42 = 0; g.n43 = -1; g.n44 = 0; return g;
}; THREE.Matrix4.makePerspective = function (e, c, g, b) {
  let a,
    f,
    h,
    d; a = g * Math.tan(e * Math.PI / 360); f = -a; h = f * c; d = a * c; return THREE.Matrix4.makeFrustum(h, d, f, a, g, b);
  ...
  let d,
    ...
    n,
    e,
    b; d = new THREE.Matrix4(); n = o - c; e = a - k; b = f - g; l = (o + c) / n; j = (a + k) / e; i = (f + g) / b; d.n11 = 2 / n; d.n12 = 0; d.n13 = 0; d.n14 = -l; d.n21 = 0; d.n22 = 2 / e; d.n23 = 0; d.n24 = -j; d.n31 = 0; d.n32 = 0; d.n33 = -2 / b; d.n34 = -i; d.n41 = 0; d.n42 = 0; d.n43 = 0; d.n44 = 1; return d;
}; THREE.Vertex = function (a, b) { this.position = a || new THREE.Vector3(); this.positionWorld = new THREE.Vector3(); this.positionScreen = new THREE.Vector3(); this.normal = b || new THREE.Vector3(); this.normalWorld = new THREE.Vector3(); this.normalScreen = new THREE.Vector3(); this.__visible = true; }; THREE.Vertex.prototype = { toString() { return `THREE.Vertex ( position: ${this.position}, normal: ${this.normal} )`; } }; THREE.Face3 = function (e, d, h, g, f) { this.a = e; this.b = d; this.c = h; this.centroid = new THREE.Vector3(); this.normal = g instanceof THREE.Vector3 ? g : new THREE.Vector3(); this.vertexNormals = g instanceof Array ? g : []; this.material = f instanceof Array ? f : [f]; }; THREE.Face3.prototype = { toString() { return `THREE.Face3 ( ${this.a}, ${this.b}, ${this.c} )`; } }; THREE.Face4 = function (f, e, j, i, h, g) { this.a = f; this.b = e; this.c = j; this.d = i; this.centroid = new THREE.Vector3(); this.normal = h instanceof THREE.Vector3 ? h : new THREE.Vector3(); this.vertexNormals = h instanceof Array ? h : []; this.material = g instanceof Array ? g : [g]; }; THREE.Face4.prototype = { toString() { return `THREE.Face4 ( ${this.a}, ${this.b}, ${this.c} ${this.d} )`; } }; THREE.UV = function (b, a) { this.u = b || 0; this.v = a || 0; }; THREE.UV.prototype = { copy(a) { this.u = a.u; this.v = a.v; }, toString() { return `THREE.UV (${this.u}, ${this.v})`; } }; THREE.Geometry = function () { this.vertices = []; this.faces = []; this.uvs = []; }; THREE.Geometry.prototype = {
  computeCentroids() {
    let c,
      b,
      a; for (c = 0, b = this.faces.length; c < b; c++) { a = this.faces[c]; a.centroid.set(0, 0, 0); if (a instanceof THREE.Face3) { a.centroid.addSelf(this.vertices[a.a].position); a.centroid.addSelf(this.vertices[a.b].position); a.centroid.addSelf(this.vertices[a.c].position); a.centroid.divideScalar(3); } else if (a instanceof THREE.Face4) { a.centroid.addSelf(this.vertices[a.a].position); a.centroid.addSelf(this.vertices[a.b].position); a.centroid.addSelf(this.vertices[a.c].position); a.centroid.addSelf(this.vertices[a.d].position); a.centroid.divideScalar(4); } }
  },
  computeNormals(m) {
    let e,
      b,
  ...
  THREE.Renderer.call(this); let e = null,
    ...
    let q,
      ...
      l,
      k,
      j; e = g.projectScene(p, r); for (q = 0, h = e.length; q < h; q++) { o = e[q]; if (o instanceof THREE.RenderableParticle) { k = o.x * f + f; j = o.y * d + d; for (i = 0, n = o.material.length; i < n; i++) { s = o.material[i]; if (s instanceof THREE.ParticleDOMMaterial) { l = s.domElement; l.style.left = `${k}px`; l.style.top = `${j}px`; } } } }
  };
  ...
  let A = null,
    ...
    C = new THREE.UV(),
    d = new THREE.Vector2(),
    b = new THREE.Vector2(); this.domElement = s; this.autoClear = true; this.setSize = function (I, H) { n = I; r = H; k = n / 2; p = r / 2; s.width = n; s.height = r; D.set(-k, -p, k, p); }; this.clear = function () { if (!q.isEmpty()) { q.inflate(1); q.minSelf(D); t.setTransform(1, 0, 0, -1, k, p); t.clearRect(q.getX(), q.getY(), q.getWidth(), q.getHeight()); q.empty(); } }; this.render = function (ac, Z) {
    let ab,
      K,
      M,
      U,
    ...
    let H,
      ...
      Q,
      T,
      K; if (P instanceof THREE.ParticleCircleMaterial) { if (l) { x.copyRGB(f); u(O, M, x); o.copyRGBA(P.color); o.multiplySelfRGB(x); o.updateStyleString(); } else { o = P.color; }H = M.scale.x * k; U = M.scale.y * p; z.set(J - H, I - U, J + H, I + U); if (!D.instersects(z)) { return; }t.save(); t.translate(J, I); t.rotate(-M.rotation); t.scale(H, U); t.beginPath(); t.arc(0, 0, 1, 0, y, true); t.closePath(); t.fillStyle = o.__styleString; t.fill(); t.restore(); } else if (P instanceof THREE.ParticleBitmapMaterial) { Q = P.bitmap; T = Q.width / 2; K = Q.height / 2; S = M.scale.x * k; R = M.scale.y * p; H = S * T; U = R * K; N = P.offset.x * S; L = P.offset.y * R; z.set(J + N - H, I + L - U, J + N + H, I + L + U); if (!D.instersects(z)) { return; }t.save(); t.translate(J, I); t.rotate(-M.rotation); t.scale(S, -R); t.translate(-T + P.offset.x, -K - P.offset.y); t.drawImage(Q, 0, 0); t.restore(); }
  } function e(H, N, J, I, K, L, M) { if (L instanceof THREE.LineColorMaterial) { if (l) { x.copyRGB(f); u(M, K, x); o.copyRGBA(L.color); o.multiplySelfRGB(x); o.updateStyleString(); } else { o = L.color; }t.lineWidth = L.lineWidth; t.lineJoin = 'round'; t.lineCap = 'round'; t.strokeStyle = o.__styleString; t.stroke(); z.inflate(t.lineWidth); } } function i(J, I, H, S, P, O, L, N, M) {
    let Q,
      R,
      K; if (N instanceof THREE.MeshColorFillMaterial) { if (l) { x.copyRGB(f); a(M, L, x); o.copyRGBA(N.color); o.multiplySelfRGB(x); o.updateStyleString(); } else { o = N.color; }t.beginPath(); t.moveTo(J, I); t.lineTo(H, S); t.lineTo(P, O); t.lineTo(J, I); t.closePath(); t.fillStyle = o.__styleString; t.fill(); } else if (N instanceof THREE.MeshColorStrokeMaterial) { if (l) { x.copyRGB(f); a(M, L, x); o.copyRGBA(N.color); o.multiplySelfRGB(x); o.updateStyleString(); } else { o = N.color; }t.beginPath(); t.moveTo(J, I); t.lineTo(H, S); t.lineTo(P, O); t.lineTo(J, I); t.closePath(); t.lineWidth = N.lineWidth; t.lineJoin = 'round'; t.lineCap = 'round'; t.strokeStyle = o.__styleString; t.stroke(); z.inflate(t.lineWidth); } else if (N instanceof THREE.MeshBitmapMaterial) { Q = N.bitmap; R = Q.width - 1; K = Q.height - 1; G.copy(L.uvs[0]); F.copy(L.uvs[1]); E.copy(L.uvs[2]); G.u *= R; G.v *= K; F.u *= R; F.v *= K; E.u *= R; E.v *= K; w(Q, J, I, H, S, P, O, G.u, G.v, F.u, F.v, E.u, E.v); }
  } function g(N, M, V, T, I, H, P, O, W, U, K, J, L, R, X) {
    let Y,
      Q,
      S; if (R instanceof THREE.MeshColorFillMaterial) { if (l) { x.copyRGB(f); a(X, L, x); o.copyRGBA(R.color); o.multiplySelfRGB(x); o.updateStyleString(); } else { o = R.color; }t.beginPath(); t.moveTo(N, M); t.lineTo(V, T); t.lineTo(I, H); t.lineTo(P, O); t.lineTo(N, M); t.closePath(); t.fillStyle = o.__styleString; t.fill(); } else if (R instanceof THREE.MeshColorStrokeMaterial) { if (l) { x.copyRGB(f); a(X, L, x); o.copyRGBA(R.color); o.multiplySelfRGB(x); o.updateStyleString(); } else { o = R.color; }t.beginPath(); t.moveTo(N, M); t.lineTo(V, T); t.lineTo(I, H); t.lineTo(P, O); t.lineTo(N, M); t.closePath(); t.lineWidth = R.lineWidth; t.lineJoin = 'round'; t.lineCap = 'round'; t.strokeStyle = o.__styleString; t.stroke(); z.inflate(t.lineWidth); } else if (R instanceof THREE.MeshBitmapMaterial) { Y = R.bitmap; Q = Y.width - 1; S = Y.height - 1; G.copy(L.uvs[0]); F.copy(L.uvs[1]); E.copy(L.uvs[2]); C.copy(L.uvs[3]); G.u *= Q; G.v *= S; F.u *= Q; F.v *= S; E.u *= Q; E.v *= S; C.u *= Q; C.v *= S; w(Y, N, M, V, T, P, O, G.u, G.v, F.u, F.v, C.u, C.v); w(Y, W, U, I, H, K, J, F.u, F.v, E.u, E.v, C.u, C.v); }
  ...
  } function c(I, H) { j.sub(H, I); j.unit(); j.multiplyScalar(0.75); H.addSelf(j); I.subSelf(j); }
  ...
  let w = null,
    ...
    let S,
      ...
      C,
      L,
      I; if (this.autoClear) { this.clear(); }w = r.projectScene(T, Q); o = 0; f = 0; i = T.lights.length > 0; if (i) { x(T, c); } for (S = 0, E = w.length; S < E; S++) { F = w[S]; v.empty(); if (F instanceof THREE.RenderableParticle) { K = F.x * p; H = F.y * -b; for (N = 0, R = F.material.length; N < R; N++) { M = F.material[N]; j(K, H, F, M, T); } } else if (F instanceof THREE.RenderableFace3) { K = F.v1.x * p; H = F.v1.y * -b; P = F.v2.x * p; O = F.v2.y * -b; D = F.v3.x * p; C = F.v3.y * -b; v.addPoint(K, H); v.addPoint(P, O); v.addPoint(D, C); if (!y.instersects(v)) { continue; }N = 0; R = F.meshMaterial.length; while (N < R) { M = F.meshMaterial[N++]; if (M instanceof THREE.MeshFaceMaterial) { J = 0; G = F.faceMaterial.length; while (J < G) { M = F.faceMaterial[J++]; h(K, H, P, O, D, C, F, M, T); } continue; }h(K, H, P, O, D, C, F, M, T); } } else if (F instanceof THREE.RenderableFace4) { K = F.v1.x * p; H = F.v1.y * -b; P = F.v2.x * p; O = F.v2.y * -b; D = F.v3.x * p; C = F.v3.y * -b; L = F.v4.x * p; I = F.v4.y * -b; v.addPoint(K, H); v.addPoint(P, O); v.addPoint(D, C); v.addPoint(L, I); if (!y.instersects(v)) { continue; }N = 0; R = F.meshMaterial.length; while (N < R) { M = F.meshMaterial[N++]; if (M instanceof THREE.MeshFaceMaterial) { J = 0; G = F.faceMaterial.length; while (J < G) { M = F.faceMaterial[J++]; e(K, H, P, O, D, C, L, I, F, M, T); } continue; }e(K, H, P, O, D, C, L, I, F, M, T); } } }
  }; function x(G, E) {
    let D,
      F,
      C; E.setRGBA(1, 1, 1, 1); for (D = 0, F = G.lights.length; D < F; D++) { C = G.lights[D]; if (C instanceof THREE.AmbientLight) { E.r *= C.color.r; E.g *= C.color.g; E.b *= C.color.b; } }
  } function q(H, F, E) {
    let D,
      G,
      C; for (D = 0, G = H.lights.length; D < G; D++) { C = H.lights[D]; if (C instanceof THREE.DirectionalLight) { E.r += C.color.r; E.g += C.color.g; E.b += C.color.b; } else if (C instanceof THREE.PointLight) { E.r += C.color.r; E.g += C.color.g; E.b += C.color.b; } }
  } function a(I, G, E) {
    let D,
      H,
      C,
      F; for (D = 0, H = I.lights.length; D < H; D++) { C = I.lights[D]; if (C instanceof THREE.DirectionalLight) { F = G.normalWorld.dot(C.position) * C.intensity; if (F > 0) { E.r += C.color.r * F; E.g += C.color.g * F; E.b += C.color.b * F; } } else if (C instanceof THREE.PointLight) { g.sub(C.position, G.centroidWorld); g.normalize(); F = G.normalWorld.dot(g) * C.intensity; if (F > 0) { E.r += C.color.r * F; E.g += C.color.g * F; E.b += C.color.b * F; } } }
  } function j(C, G, D, E, F) { B = t(f++); B.setAttribute('cx', C); B.setAttribute('cy', G); B.setAttribute('r', D.scale.x * p); if (E instanceof THREE.ParticleCircleMaterial) { if (i) { u.copyRGB(c); q(F, D, u); l.copyRGBA(E.color); l.multiplySelfRGB(u); l.updateStyleString(); } else { l = E.color; }B.setAttribute('style', `fill: ${l.__styleString}`); }s.appendChild(B); } function h(E, D, C, K, J, I, F, H, G) { B = n(o++); B.setAttribute('d', `M ${E} ${D} L ${C} ${K} L ${J},${I}z`); if (H instanceof THREE.MeshColorFillMaterial) { if (i) { u.copyRGB(c); a(G, F, u); l.copyRGBA(H.color); l.multiplySelfRGB(u); l.updateStyleString(); } else { l = H.color; }B.setAttribute('style', `fill: ${l.__styleString}`); } else if (H instanceof THREE.MeshColorStrokeMaterial) { if (i) { u.copyRGB(c); a(G, F, u); l.copyRGBA(H.color); l.multiplySelfRGB(u); l.updateStyleString(); } else { l = H.color; }B.setAttribute('style', `fill: none; stroke: ${l.__styleString}; stroke-width: ${H.lineWidth}; stroke-linecap: round; stroke-linejoin: round`); }s.appendChild(B); } function e(G, E, C, M, L, K, F, D, H, J, I) { B = n(o++); B.setAttribute('d', `M ${G} ${E} L ${C} ${M} L ${L},${K} L ${F},${D}z`); if (J instanceof THREE.MeshColorFillMaterial) { if (i) { u.copyRGB(c); a(I, H, u); l.copyRGBA(J.color); l.multiplySelfRGB(u); l.updateStyleString(); } else { l = J.color; }B.setAttribute('style', `fill: ${l.__styleString}`); } else if (J instanceof THREE.MeshColorStrokeMaterial) { if (i) { u.copyRGB(c); a(I, H, u); l.copyRGBA(J.color); l.multiplySelfRGB(u); l.updateStyleString(); } else { l = J.color; }B.setAttribute('style', `fill: none; stroke: ${l.__styleString}; stroke-width: ${J.lineWidth}; stroke-linecap: round; stroke-linejoin: round`); }s.appendChild(B); } function n(C) { if (d[C] == null) { d[C] = document.createElementNS('http://www.w3.org/2000/svg', 'path'); if (z == 0) { d[C].setAttribute('shape-rendering', 'crispEdges'); } return d[C]; } return d[C]; } function t(C) { if (m[C] == null) { m[C] = document.createElementNS('http://www.w3.org/2000/svg', 'circle'); if (z == 0) { m[C].setAttribute('shape-rendering', 'crispEdges'); } return m[C]; } return m[C]; }
  ...
  let j = document.createElement('canvas'),
    ...
    k = 1,
    h = 2,
    d = 3; this.domElement = j; this.autoClear = true; g(); f(); this.setSize = function (n, m) { j.width = n; j.height = m; c.viewport(0, 0, j.width, j.height); }; this.clear = function () { c.clear(c.COLOR_BUFFER_BIT | c.DEPTH_BUFFER_BIT); }; this.setupLights = function (s) {
    let q,
      r,
      m,
      p,
      o,
      n; c.uniform1i(e.enableLighting, s.lights.length); for (q = 0, r = s.lights.length; q < r; q++) { n = s.lights[q]; if (n instanceof THREE.AmbientLight) { m = n.color; c.uniform3f(e.ambientColor, m.r, m.g, m.b); } else if (n instanceof THREE.DirectionalLight) { m = n.color; p = n.position; o = n.intensity; c.uniform3f(e.lightingDirection, p.x, p.y, p.z); c.uniform3f(e.directionalColor, m.r * o, m.g * o, m.b * o); } else if (n instanceof THREE.PointLight) { m = n.color; p = n.position; o = n.intensity; c.uniform3f(e.pointPosition, p.x, p.y, p.z); c.uniform3f(e.pointColor, m.r * o, m.g * o, m.b * o); } }
